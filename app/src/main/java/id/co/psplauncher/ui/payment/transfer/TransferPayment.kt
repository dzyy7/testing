...
class TransferPayment : Fragment() {
    ...
    private var _binding: FragmentTransferPaymentBinding? = null
    ...
    companion object {
        fun newInstance(cartId: String) = TransferPayment().apply {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTransferPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
